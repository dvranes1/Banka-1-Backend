...
class NotificationServiceUnitTest {
    ...
    @Test
    void sendNotificationRendersVariablesAndBuildsExpectedEmailMessage() {
        ...
        when(templateFactory.resolve(NotificationType.EMPLOYEE_CREATED)).thenReturn(
                new EmailTemplate(
                        "Activation Email",
        ...
        notificationService.sendNotification(request, NotificationType.EMPLOYEE_CREATED);
